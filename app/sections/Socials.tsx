        ...
        <div className="w-vw-full h-[50px] my-[80px] flex justify-center items-center">
            <div className="w-[90%] flex gap-5 items-center justify-between">
                <div className="flex gap-5 items-center">
                    ...
                    <FontAwesomeIcon icon={faSquareFacebook} className='text-[#005ca5] h-[40px] roundned-[8px] cursor-pointer' />
                    <FontAwesomeIcon icon={faSquareXTwitter} className='text-[#005ca5] h-[40px] roundned-[8px] cursor-pointer' />
                    <FontAwesomeIcon icon={faLinkedin} className='text-[#005ca5] h-[40px] roundned-[8px] cursor-pointer' />
                    <FontAwesomeIcon icon={faSquareYoutube} className='text-[#005ca5] h-[40px] roundned-[8px] cursor-pointer' />
                    <FontAwesomeIcon icon={faSquareInstagram} className='text-[#005ca5] h-[40px] roundned-[8px] cursor-pointer' />
                </div>
